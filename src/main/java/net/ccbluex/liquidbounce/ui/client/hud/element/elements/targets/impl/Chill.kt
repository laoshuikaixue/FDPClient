...
class Chill(inst: Target2): TargetStyle("Chill", inst) {

    private val chillFontSpeed = FloatValue("Chill-FontSpeed", 0.5F, 0.01F, 1F).displayable { targetInstance.styleValue.get().equals("chill", true) }
    private val chillRoundValue = BoolValue("Chill-RoundedBar", true).displayable { targetInstance.styleValue.get().equals("chill", true) }
    ...
    override fun drawTarget(entity: EntityPlayer) {
        ...
        // health bar
        RenderUtils.drawRoundedRect(4F, 38F, tWidth - 4F, 44F, 3F, targetInstance.barColor.darker().rgb)
