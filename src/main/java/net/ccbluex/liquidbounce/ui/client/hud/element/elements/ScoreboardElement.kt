...
class ScoreboardElement(
    ...
    private val bordRad = FloatValue("BorderRadius", 3.2F, 0F, 10F)
    ...
    override fun drawElement(partialTicks: Float): Border? {
        ...
        RenderUtils.drawRoundedRect(l1-2f,-2f,5f,maxHeight + fontRenderer.FONT_HEIGHT.toFloat(),bordRad.get(),backColor)
