...
class Text2(x: Double = 10.0, y: Double = 10.0, scale: Float = 1F,
    ...
    companion object {
        ...
        fun defaultClient(): Text2 {
            val text = Text2(x = 5.0, y = 5.0, scale = 1F)
    ...
    private val distanceValue = IntegerValue("Line-Distance", 15, 0, 400)
    private val gradientAmountValue = IntegerValue("Gradient-Amount", 25, 1, 50)
    private val shadow = BoolValue("Shadow", true)
    private var fontValue = FontValue("Font", Fonts.fontMiSansNormal40)
    ...
    private fun getReplacement(str: String): String? {
        ...
        return when (str) {
            ...
            "huayutingbans" -> return LiquidBounce.combatManager.gethuayutingbans().toString()
            "kills" -> return LiquidBounce.combatManager.getKillCounts().toString()
