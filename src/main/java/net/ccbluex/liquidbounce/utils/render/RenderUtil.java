...
public final class RenderUtil extends MinecraftInstance {
    ...
    public static void autoExhibition(double x, double y, double x1, double y1, double size) {
        ...
        rectangleBordered(x + 2.5, y + 2.5, x1 + size - 2.5, y1 + size - 2.5, 0.5, Colors.getColor(61),  net.ccbluex.liquidbounce.utils.Colors.getColor(0));
    }
    ...
    public static void Gamesense(double x, double y, double x1, double y1, double size , float color1, float color2 , float color3) {
        RenderUtil.rectangleBordered(x, y, x1 + size, y1 + size, 0.5d, Colors2.getColor(90), Colors2.getColor(0));
        RenderUtil.rectangleBordered(x + 1.0f, y + 1.0f, (x1 + size - 1.0f), y1 + size - 1.0f, 1.0, Colors2.getColor(90),
                Colors2.getColor(61));
        RenderUtil.rectangleBordered(x + 2.5, y + 2.5, (x1 + size) - 2.5, (y1 + size) - 2.5, 0.5, Colors2.getColor(61),
                Colors2.getColor(0));
