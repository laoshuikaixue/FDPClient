...
public class Window {
    ...
    public void render(int mouseX, int mouseY) {
        ...
        if (category.name().equals("Misc")) {
            Fonts.fontMiSansNormal35.drawStringWithShadow("Exploit", x + 4, y + 5, -1);
        }
        if (category.name().equals("World")) {
            Fonts.fontMiSansNormal35.drawStringWithShadow("Misc", x + 4, y + 5, -1);
        }
        if (category.name().equals("Render")) {
            Fonts.fontMiSansNormal35.drawStringWithShadow("Visuals", x + 4, y + 5, -1);
        }
        if (!category.name().equals("Render") && !category.name().equals("Misc") && !category.name().equals("World")) {
            Fonts.fontMiSansNormal35.drawStringWithShadow(category.name(), x + 4, y + 5, -1);
        }
        //Icons start
