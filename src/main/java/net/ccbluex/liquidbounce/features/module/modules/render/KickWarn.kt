...
@ModuleInfo(name = "KickWarn", category = ModuleCategory.RENDER)
class KickWarn : Module() {
    ...
    fun onRender2D(e: Render2DEvent) {
        ...
        val colors = arrayOf(Color(0,255,0), Color(225, 225, 100), Color(	220,20,60))
        ...
        if (packetsCheck.get()) {
            Fonts.fontMiSansNormal40.drawString(
                "TooMany Packets",
                x + (100f - Fonts.fontMiSansNormal40.getStringWidth("TooMany Packets")) / 2f,
                y,
            ...
            RenderUtils.drawRect(
                x,
                y + 10f,
                (x + translat.x).coerceAtMost(width),
                y + 25f,
        ...
        if (vanillaCheck.get()) {
            Fonts.fontMiSansNormal40.drawString(
                "Vanilla Kick",
                x + (100f - Fonts.fontMiSansNormal40.getStringWidth("Vanilla Kick")) / 2f,
                y + 35f,
                Color(255, 255, 255, 200).rgb,
                false
            )
            ...
            RenderUtils.drawRect(
                x,
                y + 45f,
                (x + translat.y).coerceAtMost(width),
                y + 60f,
