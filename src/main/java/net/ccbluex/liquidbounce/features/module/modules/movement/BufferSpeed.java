...
@ModuleInfo(name = "BufferSpeed", category = ModuleCategory.MOVEMENT)
public class BufferSpeed extends Module {
    ...
    public void onUpdate(final UpdateEvent event) {
        ...
        if(!MovementUtils.INSTANCE.isMoving() || mc.thePlayer.isSneaking() || mc.thePlayer.isInWater() ||
        ...
        if(mc.thePlayer.onGround) {
            ...
            final float currentSpeed = MovementUtils.INSTANCE.getSpeed();
            ...
            if(bufferValue.get() && speed > 0.2F) {
                ...
                MovementUtils.INSTANCE.strafe((float) speed);
            }
        }else{
            speed = 0F;
