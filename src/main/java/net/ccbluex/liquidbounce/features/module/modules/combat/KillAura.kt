...
class KillAura : Module() {
    ...
    private val autoBlockPacketValue = ListValue("AutoBlockPacket", arrayOf("AfterTick", "AfterAttack", "Vanilla", "None"), "AfterTick").displayable { autoBlockValue.equals("Range") }
