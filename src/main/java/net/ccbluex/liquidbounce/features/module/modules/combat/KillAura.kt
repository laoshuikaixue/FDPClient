...
class KillAura : Module() {
    ...
    private val minPredictSizeValue: FloatValue = object : FloatValue("MinPredictSize", 0.1f, 0.1f, 5f) {
        override fun onChanged(oldValue: Float, newValue: Float) {
    ...
    // Visuals
    private val markValue = ListValue("Mark", arrayOf("Liquid", "FDP", "Block", "Jello", "Sims", "None"), "Jello")
